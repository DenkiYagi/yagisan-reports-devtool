...
function yagisan_reports_devtool_Main_main() {
	...
	root.command("glyphdata","Glyph Data Manipulation",function(cmd) {
		return cmd.command("generate <font>","Generate glyph data from a font file",function(subcmd) {
			subcmd.positional("font",{ describe : "Font file path (TTF/OTF)", type : "string"});
			subcmd.option("out",{ describe : "Set output file path", type : "string", alias : ["O"]});
			return subcmd.check(function(argv,options) {
